...
$$
\delta_Y^2(\mathcal{L}) = \int_0^{\bar{\tau}} \sqrt{\bar{\tau}} (Y \cdot Y \cdot R + 2 <\nabla_Y \nabla_Y X, X> + 2|\nabla_Y X|^2) d\tau
$$

$$
= \int_0^{\bar{\tau}} \sqrt{\bar{\tau}} (Y \cdot Y \cdot R + 2 <\nabla_X \nabla_Y Y, X> + 2 <R(Y, X), Y, X> + 2|\nabla_X Y|^2) d\tau
$$
...
$$
\delta_Y^2(\mathcal{L}) = 2 <\nabla_Y Y, X> \sqrt{\bar{\tau}} +
$$

$$
\int_0^{\bar{\tau}} \sqrt{\bar{\tau}} (\nabla_Y \nabla_Y R + 2 <R(Y, X), Y, X> + 2|\nabla_X Y|^2
$$

$$
+ 2\nabla_X \text{Ric}(Y, Y) - 4\nabla_Y \text{Ric}(Y, X)) d\tau,
\quad \text{(7.7)}
$$
...
$$
\nabla_X Y = -\text{Ric}(Y, \cdot) + \frac{1}{2\tau} Y
\quad \text{(7.8)}
$$
